1. Architecture and CodeHighlights of some of my projects: https://github.com/LeandroParisi/PrivatePortfolio
2. Algorithms and DataStructure Exercises: https://github.com/LeandroParisi/LogicProblemsAndStudies
3. WhatsappBot (bot to sale and system to manage restaurant orders)
   1. v2 (code may not be running perfectly since it's still beeing worked on):
...
4. Simple system I did for one of my first job interviews ever:
